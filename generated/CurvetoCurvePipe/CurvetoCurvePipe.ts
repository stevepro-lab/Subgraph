...
export class CurvetoCurvePipe extends ethereum.SmartContract {
  static bind(address: Address): CurvetoCurvePipe {
    return new CurvetoCurvePipe("CurvetoCurvePipe", address);
  }
...
export class Curve2CurveCall extends ethereum.Call {
  get inputs(): Curve2CurveCall__Inputs {
    return new Curve2CurveCall__Inputs(this);
  }

  get outputs(): Curve2CurveCall__Outputs {
    return new Curve2CurveCall__Outputs(this);
  }
}

export class Curve2CurveCall__Inputs {
  _call: Curve2CurveCall;

  constructor(call: Curve2CurveCall) {
    this._call = call;
  }
...
export class Curve2CurveCall__Outputs {
  _call: Curve2CurveCall;
